...
<nav class="sidebar">
      ...
      <div class="menu-content">
        ...
        <ul class="menu-items" style="list-style-type: none;">
            ...
            <div class="pt-3"><a href="../images/adminlogo/adminlogo.php" class="pt-3">
...
<div class="content border shadow-lg p-3 mb-5 bg-body rounded">
    <h2 class="fw-bold p-3  bg-light rounded text-center border-bottom  overflow-hidden">Header Settings</h2>
    <?php
            ...
            ?>
    <form action="hcode.php" method="post" class="px-3  overflow-hidden" enctype="multipart/form-data">
        <div class="form-group mt-3">
            <label for="">Email id</label>
            <input type="text" class="form-control shadow-sm" value="<?= $post['email'] ?>" name="email" id="email"  placeholder="Enter your email">
        </div>
        
        <div class="form-group mt-3">
            <label>Phone NO</label>
            <input type="text" class="form-control shadow-sm" value="<?= $post['phone'] ?>" name="phone" id="phone"  placeholder="Enter your phone number">
        </div>

        <hr>
        <button type="submit" name="header" class="btn btn-primary shadow-sm">Update</button>
...
<h2 class="fw-bold p-3 mt-3 mb-5 bg-light rounded text-center border-bottom overflow-hidden">LOGO Settings</h2>
    <?php
            $post = "SELECT * FROM header ";
            $post_run = mysqli_query($con, $post);
    ...
    <form action="hcode.php" method="post" class="px-3  overflow-hidden" enctype="multipart/form-data">
        <div class="form-group mt-3">
            <label class="mr-2">gmail logo</label>
            <input type="file" id="image" class="shadow-sm"  name="image">
        <div class="form-group mt-3">
            <label class="mr-2">call logo</label>
            <input type="file" id="pimage" class="shadow-sm"  name="pimage">
        </div>
        <hr>
        <button type="submit" name="logo" class="btn btn-primary shadow-sm">Update</button>
