...
<h2 class="fw-bold p-3 mt-3 mb-5 bg-light rounded text-center border-bottom overflow-hidden">LOGO Settings</h2>
    ...
    <form action="hcode.php" method="post" class="px-3  overflow-hidden" enctype="multipart/form-data">
        <div class="form-group mt-3">
            <label class="mr-2">Company logo</label>
            <input class="mb-3" type="file" id="image" class="shadow-sm"  name="image">
            <img class="ms-4" src="../images/logo/header/<?= $post['image'] ?>" alt="logo" width="50" height="50">
