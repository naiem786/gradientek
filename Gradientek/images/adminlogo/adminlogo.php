...
<nav class="sidebar">
      ...
      <div class="menu-content">
        ...
        <ul class="menu-items" style="list-style-type: none;">
            ...
            <div class="pt-3 text-center"><a href="adminlogo.php" class="pt-3">
              <?php
            ...
            ?>
              <img  src="../adminlogo/<?= $post['adminlogo'] ?>" href="adminlogo.php" class="Admin logo" style="height: 60px;">
                  <?php
              }
              } else {
              ?>
...
<h2 class="fw-bold p-3 mt-3 mb-5 bg-light rounded text-center border-bottom overflow-hidden">Admin Logo </h2>
    <?php
            ...
            if (mysqli_num_rows($post_run) > 0) {
                foreach ($post_run as $post) {
            ?>
    <form action="adminlogocode.php" method="post" class="px-3  overflow-hidden" enctype="multipart/form-data">
        

        <div class="form-group mt-3">
            <label class="mr-2">Choose admin logo</label>
            <input type="file" id="adminlogo" class="shadow-sm"  name="adminlogo">
            <img class="ms-4" src="../adminlogo/<?= $post['adminlogo'] ?>" alt="logo" width="50" height="50">
